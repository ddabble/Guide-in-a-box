...
protected:
	...
	*/
	HUDobject_Animated(GLuint program, const GraphicsObjectManager& graphics) : HUDobject_Dynamic(program, graphics) {}

	/* Texture storage should be handled by the derived class. */
	HUDobject_Animated(GLuint program, const GraphicsObjectManager& graphics, glm::vec2 pos, GLfloat width, GLfloat height) : HUDobject_Dynamic(program, graphics, pos, width, height) {}
